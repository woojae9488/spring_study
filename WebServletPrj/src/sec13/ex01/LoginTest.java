...
public class LoginTest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("Total connected user : " + LoginImpl2.total_user + "<br><br>");
		out.println("Connected Id : <br>");
		List<String> list = (ArrayList<String>) context.getAttribute("user_list");
		for (int i = 0; i < list.size(); i++) {
			out.println(list.get(i) + "<br>");
		}
		out.println("<a href='eventLogout?user_id=" + user_id + "'>로그아웃 </a>");
